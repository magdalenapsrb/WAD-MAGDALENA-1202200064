<?php 
  ...
  if(isset($_SESSION['login'])){
    header('Location: Home-Magdalena.php');
  }
      ...
      <div class="container" >
        ...
        <div class="col">
          <div class="position-relative" style="margin-left: 70%; margin-top: 10px;">
            <a href="Login-Magdalena.php" class="text text-white">Login</a>
          </div>
        </div>
      </div>
    </nav>
       ...
       <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
         <div class="carousel-inner">
           <div class="carousel-item active">
             <img src="login1.jpeg" class="d-block w-100" alt="...">
           </div>
           <div class="carousel-item">
             <img src="regis2.jpg" class="d-block w-100" alt="...">
           </div>
           <div class="carousel-item">
             <img src="regis3.jpg" class="d-block w-100" alt="...">
           </div>
         </div>
       </div>
          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <h3>Register</h3>
                  ...
                  <div class="text-center">
                    <button type="submit" name="regis" onclick="myFunction()" class="btn btn-primary text-center" style="width: 30%;">Daftar</button>
                    <br><br>
                    <p>Anda sudah punya akun? <a href="Login-Magdalena.php">Login</a></p>
                  </div>
                </form>
              </div>
            </div>
